...
```shell
docker buildx imagetools create -t apache/kvrocks:${release_version} apache/kvrocks:nightly-${20xxxxxx}-v${release_version}-${commit_sha}
docker buildx imagetools create -t apache/kvrocks:latest apache/kvrocks:nightly-${20xxxxxx}-v${release_version}-${commit_sha}
```
